...
public final class VlcSession {
    ...
    public VlcSession(String sid, String username, Path streamsRootFs, String streamsRootUrl) {
        this.sid = sid;
    ...
    /** Filesystem directory where VLC writes index.m3u8 and seg-*.ts */
